		...
		<div class="relative z-10">
			<div class="flex items-center gap-3">
				<div class="flex h-14 w-14 items-center justify-center rounded-xl bg-white/90 shadow-lg backdrop-blur-sm">
					<CloudArrowDown class="h-7 w-7 text-svelte-500" weight="duotone" />
				</div>
				<div>
					<h1 class="text-3xl font-bold text-white">External Content Hub</h1>
					<p class="mt-1 text-sm text-white/90">
						Seamlessly import from YouTube and GitHub
					</p>
				</div>
			</div>
		</div>
