...
<div class="space-y-6">
	...
	{#if $toggleMessage || $deleteMessage}
		...
		<div class="rounded-md {message.success ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'} p-4">
			<div class="flex">
				<div class="ml-3">
				...
				{#each data.placements as placement}
					<tr>
						...
						<td class="px-6 py-4 text-sm">
							<span
								class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 {placement.is_active
