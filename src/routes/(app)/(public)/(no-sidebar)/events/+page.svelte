		...
		{:else}
			<div class="grid gap-3">
				{#each data.upcomingEvents as event}
					<div
						class="hover:border-svelte-300 flex gap-4 rounded-lg border border-gray-200 bg-white p-4 transition-colors"
					>
		...
		{:else}
			<div class="grid gap-3">
				{#each data.pastEvents as event}
					<div
						class="flex gap-4 rounded-lg border border-gray-200 bg-white p-4 transition-colors hover:border-gray-300"
					>
						<div class="flex-shrink-0">
							{#if event.socialCardUrl}
								<img
								...
								/>
							{:else}
								<div class="flex h-24 w-24 items-center justify-center rounded-lg bg-gray-200">
