...
describe('InteractionsService', () => {
  ...
  describe('getUserLikesAndSaves', () => {
    ...
    test('should return correct likes and saves for user1', () => {
      const result = interactionsService.getUserLikesAndSaves('user1', ['content1', 'content2', 'content3']);
    ...
    test('should return correct likes and saves for user2', () => {
      const result = interactionsService.getUserLikesAndSaves('user2', ['content1', 'content2', 'content3']);
