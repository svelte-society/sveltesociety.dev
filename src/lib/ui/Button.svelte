...
let {
  ...
  const baseStyles = 'inline-flex items-center justify-center gap-1 rounded-md px-4 py-2 font-medium focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-gray-200 disabled:text-gray-700 cursor-pointer'
</script>
