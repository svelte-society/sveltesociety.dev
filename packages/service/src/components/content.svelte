...
<article>
    <header>
        ...
        {#if connected}
            <aside>
                <a href="" class:active={liked} title={liked ? 'Remove my like':'Like it'}>
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    {likes}</a>
                <a href="" class:active={saved} title={saved ? 'Remove from my bookmark':'Bookmark it'}>
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
