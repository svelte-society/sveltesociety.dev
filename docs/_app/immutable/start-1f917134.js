...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-47f14a0c.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-a535826c.js'),
				[
					'chunks/0-a535826c.js',
					'components/pages/_layout.svelte-278d3ddb.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-2fad9c0c.js',
					'chunks/Link-2f41dbb7.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-c8d04b5e.js',
					'chunks/singletons-47f14a0c.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-17278c1e.js'),
				[
					'chunks/1-17278c1e.js',
					'components/error.svelte-22e705f9.js',
					'chunks/index-2fad9c0c.js',
					'chunks/stores-c8d04b5e.js',
					'chunks/singletons-47f14a0c.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-e8fdd330.js'),
				[
					'chunks/2-e8fdd330.js',
					'components/pages/about/_layout.svelte-ddb42b06.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-2fad9c0c.js',
					'chunks/Seo-ccfb3bd7.js',
					'chunks/stores-c8d04b5e.js',
					'chunks/singletons-47f14a0c.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-84498be0.js'),
				[
					'chunks/4-84498be0.js',
					'components/pages/_page.svelte-1e32b5b5.js',
		...
		() =>
			D(
				() => import('./chunks/6-d8053067.js'),
				[
					'chunks/6-d8053067.js',
					'components/pages/cultproposals/_page.svelte-7318d8b9.js',
					'chunks/index-2fad9c0c.js',
		...
		() =>
			D(
				() => import('./chunks/7-f51c7feb.js'),
				[
					'chunks/7-f51c7feb.js',
					'chunks/_page-09cf9d98.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-f8909774.js',
		...
		() =>
			D(
				() => import('./chunks/8-dda17fea.js'),
				[
					'chunks/8-dda17fea.js',
					'components/pages/events/2021-summit-fall/_page.svx-7e9bb972.js',
					'chunks/index-2fad9c0c.js',
					'chunks/EventPage-6d6b1afa.js',
		...
		() =>
			D(
				() => import('./chunks/9-5cd41b9a.js'),
				[
					'chunks/9-5cd41b9a.js',
		...
		() =>
			D(
				() => import('./chunks/10-e16a375d.js'),
				[
					'chunks/10-e16a375d.js',
		...
		() =>
			D(
				() => import('./chunks/11-76a1ea3a.js'),
				[
					'chunks/11-76a1ea3a.js',
		...
		() =>
			D(
				() => import('./chunks/12-b16859ee.js'),
				[
					'chunks/12-b16859ee.js',
		...
		() =>
			D(
				() => import('./chunks/13-9aa61696.js'),
				[
					'chunks/13-9aa61696.js',
					'components/pages/help/submitting/_page.svelte-e0d54daf.js',
		...
		() =>
			D(
				() => import('./chunks/14-1db34ab3.js'),
				[
					'chunks/14-1db34ab3.js',
					'components/pages/markets/_page.svelte-5957eea6.js',
		...
		() =>
			D(
				() => import('./chunks/15-b462db6c.js'),
				[
					'chunks/15-b462db6c.js',
					'components/pages/news/_page.svelte-99e32f77.js',
					'chunks/index-2fad9c0c.js',
					'chunks/Select.svelte_svelte_type_style_lang-949aa272.js',
					'assets/Select-6318a4e1.css',
					'chunks/Select-8360dfd8.js',
		...
		() =>
			D(
				() => import('./chunks/17-743439ce.js'),
				[
					'chunks/17-743439ce.js',
					'components/pages/rvltproposals/_page.svelte-0d436072.js',
