...
function ct() {
	...
	do {
		...
		for (w(null), b.length = 0, N = 0; V.length; ) V.pop()();
...
function ue(t, e, n, i, s, o, r, l, c, u, f, _) {
	let d = t.length,
		m = o.length,
		h = d;
	const H = {};
...
function me(t, e, n, i, s, o, r, l = [-1]) {
	...
	if (
		((u.ctx = n
			? n(t, e.props || {}, (_, d, ...m) => {
					...
					return (
						u.ctx &&
							s(u.ctx[_], (u.ctx[_] = h)) &&
							(!u.skip_bound && u.bound[_] && u.bound[_](h), f && St(t, _)),
						d
					);
			  })
			: []),
		...
		e.intro && ot(t.$$.fragment), Tt(t, e.target, e.anchor, e.customElement), _t(), ct();
	}
	w(c);
}
class pe {
	$destroy() {
		Nt(this, 1), (this.$destroy = W);
	}
	$on(e, n) {
