...
import { S as S1 } from '../../../chunks/Seo-66e26ba0.js';
...
function U1(s) {
	...
	return {
		...
		h() {
			m(e, 'class', (l = 'svgicon ' + s[0] + ' svelte-1dyed4p')),
				m(e, 'focusable', 'false'),
				m(e, 'width', s[1]),
				m(e, 'height', s[2]),
				m(e, 'viewBox', '0 0 ' + s[3].box);
		},
		m(t, n) {
			V(t, e, n), (e.innerHTML = r);
		},
		p(t, [n]) {
			n & 1 && l !== (l = 'svgicon ' + t[0] + ' svelte-1dyed4p') && m(e, 'class', l),
				n & 2 && m(e, 'width', t[1]),
				n & 4 && m(e, 'height', t[2]);
		},
		i: O,
...
function P1(s) {
	...
	return {
		...
		l(w) {
			e = L(w, 'H5', { class: !0 });
			var N = C(e);
			(l = M(N, r)), N.forEach(h), (t = U(w)), (n = L(w, 'UL', { class: !0 }));
			var T = C(n);
			c = L(T, 'LI', {});
			var e1 = C(c);
			u = L(e1, 'SPAN', { class: !0 });
			var J = C(u);
			G(a.$$.fragment, J), (f = U(J)), (i = L(J, 'A', { href: !0, rel: !0 }));
			var K = C(i);
			(g = M(K, k)),
				K.forEach(h),
				J.forEach(h),
		...
		h() {
			m(e, 'class', 'society svelte-331ce1'),
				m(i, 'href', s[0].url),
				m(i, 'rel', 'noopener'),
				m(u, 'class', 'icon-wrapper svelte-331ce1'),
				m(n, 'class', 'society svelte-331ce1');
		},
		m(w, N) {
			V(w, e, N),
				o(e, l),
		...
		p(w, N) {
			w[0].twitter && E.p(w, N),
				w[0].telegram && I.p(w, N),
				w[0].youtube && B.p(w, N),
				w[0].githuburl && Z.p(w, N);
		},
		i(w) {
			R || (H(a.$$.fragment, w), H(E), H(I), H(B), H(Z), (R = !0));
		},
		o(w) {
			P(a.$$.fragment, w), P(E), P(I), P(B), P(Z), (R = !1);
		},
		d(w) {
			w && h(e), w && h(t), w && h(n), j(a), E && E.d(), I && I.d(), B && B.d(), Z && Z.d();
		}
	};
}
function Z1(s) {
	...
	return {
		...
		h() {
			m(e, 'class', 'continent svelte-331ce1');
		},
		m(t, n) {
			V(t, e, n), o(e, l);
		},
...
function D1(s) {
	...
	return (
		...
		{
			c() {
				(e = _('span')), W(r.$$.fragment), (l = S()), (t = _('a')), (c = z(n)), this.h();
			},
			l(a) {
				e = L(a, 'SPAN', { class: !0 });
				var f = C(e);
				G(r.$$.fragment, f), (l = U(f)), (t = L(f, 'A', { href: !0, rel: !0 }));
				var i = C(t);
				(c = M(i, n)), i.forEach(h), f.forEach(h), this.h();
			},
			h() {
				m(t, 'href', 'https://twitter.com/' + s[0].twitter),
					m(t, 'rel', 'noopener'),
					m(e, 'class', 'icon-wrapper svelte-331ce1');
			},
			m(a, f) {
				V(a, e, f), Y(r, e, null), o(e, l), o(e, t), o(t, c), (u = !0);
			},
			p: O,
			i(a) {
	...
	return (
		(r = new t1({ props: { name: 'telegram' } })),
		{
			...
			l(u) {
				e = L(u, 'SPAN', { class: !0 });
				var a = C(e);
				G(r.$$.fragment, a), (l = U(a)), (t = L(a, 'A', { href: !0, target: !0, rel: !0 }));
				var f = C(t);
				(n = M(f, 'Join on Telegram')), f.forEach(h), a.forEach(h), this.h();
			},
			h() {
				m(t, 'href', s[0].telegram),
					m(t, 'target', '_blank'),
					m(t, 'rel', 'noopener'),
					m(e, 'class', 'icon-wrapper svelte-331ce1');
			},
			m(u, a) {
				V(u, e, a), Y(r, e, null), o(e, l), o(e, t), o(t, n), (c = !0);
			},
			p: O,
			i(u) {
	...
	return (
		(r = new t1({ props: { name: 'youtube' } })),
		{
			...
			l(f) {
				e = L(f, 'SPAN', { class: !0 });
				var i = C(e);
				G(r.$$.fragment, i), (l = U(i)), (t = L(i, 'A', { href: !0, target: !0, rel: !0 }));
				var k = C(t);
				(c = M(k, n)), (u = M(k, ' YouTube Channel')), k.forEach(h), i.forEach(h), this.h();
			},
			h() {
				m(t, 'href', s[0].youtube),
					m(t, 'target', '_blank'),
					m(t, 'rel', 'noopener'),
					m(e, 'class', 'icon-wrapper svelte-331ce1');
			},
			m(f, i) {
				V(f, e, i), Y(r, e, null), o(e, l), o(e, t), o(t, c), o(t, u), (a = !0);
			},
			p: O,
			i(f) {
	...
	return (
		(l = new t1({ props: { name: 'github' } })),
		{
			...
			l(a) {
				...
				r = L(f, 'SPAN', { class: !0 });
				var i = C(r);
				G(l.$$.fragment, i), (t = U(i)), (n = L(i, 'A', { href: !0, target: !0, rel: !0 }));
				var k = C(n);
				(c = M(k, 'GitHub')), k.forEach(h), i.forEach(h), f.forEach(h), this.h();
			},
			h() {
				m(n, 'href', s[0].githuburl),
					m(n, 'target', '_blank'),
					m(n, 'rel', 'noopener'),
					m(r, 'class', 'icon-wrapper svelte-331ce1');
			},
			m(a, f) {
				V(a, e, f), o(e, r), Y(l, r, null), o(r, t), o(r, n), o(n, c), (u = !0);
			},
			p: O,
			i(a) {
...
function R1(s) {
	...
	return {
		c() {
			(e = _('div')),
				(r = _('h3')),
				(l = z('Communities Around the World')),
				(t = z(`
	...
	`));
		...
		l(g) {
			...
			r = L(d, 'H3', { class: !0 });
			var p = C(r);
			(l = M(p, 'Communities Around the World')),
				p.forEach(h),
				(t = M(
					d,
					`
	...
	`
		...
		h() {
			m(r, 'class', 'title'),
				...
				m(n, 'target', '_blank'),
				m(e, 'class', 'society-wrapper svelte-331ce1');
		},
		m(g, d) {
			V(g, e, d), o(e, r), o(r, l), o(e, t), o(e, n), o(n, c), o(e, u);
			for (let p = 0; p < i.length; p += 1) i[p].m(e, null);
			a = !0;
		},
		p(g, [d]) {
			if (d & 0) {
				...
				for (p = 0; p < f.length; p += 1) {
					...
					i[p]
						? (i[p].p(y, d), H(i[p], 1))
						: ((i[p] = b1(y)), i[p].c(), H(i[p], 1), i[p].m(e, null));
				}
				for ($1(), p = f.length; p < i.length; p += 1) k(p);
				E1();
			}
		},
		i(g) {
		...
		o(g) {
			i = i.filter(Boolean);
			for (let d = 0; d < i.length; d += 1) P(i[d]);
			a = !1;
		},
		d(g) {
			g && h(e), A1(i, g);
...
function w1(s) {
	...
	return {
		c() {
			(e = _('span')), (r = z('Past event')), this.h();
		},
		l(l) {
			e = L(l, 'SPAN', { class: !0 });
			var t = C(e);
		...
		h() {
			m(e, 'class', 'past-event svelte-16w909o');
		},
		m(l, t) {
			V(l, e, t), o(e, r);
		},
...
function x1(s) {
	...
	return (
		(f = new t1({ props: { name: 'calendar', width: '25px', height: '25px' } })),
		{
			...
			l(p) {
				e = L(p, 'ARTICLE', { class: !0 });
				var y = C(e);
				d && d.l(y), (r = U(y)), (l = L(y, 'H2', { class: !0 }));
				var D = C(l);
				t = L(D, 'A', { href: !0, class: !0 });
				var q = C(t);
				(n = M(q, s[0])), q.forEach(h), D.forEach(h), (c = U(y)), (u = L(y, 'P', {}));
				var R = C(u);
				a = L(R, 'SPAN', { class: !0 });
				var E = C(a);
			...
			h() {
				m(t, 'href', s[2]),
					m(t, 'class', 'svelte-16w909o'),
					m(l, 'class', 'svelte-16w909o'),
					m(a, 'class', 'icon-wrapper svelte-16w909o'),
					m(e, 'class', 'event-tile svelte-16w909o');
			},
			m(p, y) {
				V(p, e, y),
					d && d.m(e, null),
			...
			p(p, [y]) {
				p[3] === !0 ? d || ((d = w1()), d.c(), d.m(e, r)) : d && (d.d(1), (d = null)),
					(!g || y & 1) && _1(n, p[0]),
					(!g || y & 4) && m(t, 'href', p[2]),
					(!g || y & 2) && i !== (i = y1(p[1]) + '') && _1(k, i);
			},
			i(p) {
				g || (H(f.$$.fragment, p), (g = !0));
			},
			o(p) {
				P(f.$$.fragment, p), (g = !1);
			},
...
function G1(s) {
	...
	let X = s[0].events,
		$ = [];
	for (let v = 0; v < X.length; v += 1) $[v] = M1(z1(s, X, v));
	const k1 = (v) =>
		P($[v], 1, 1, () => {
			$[v] = null;
		});
		...
		(Q = new q1({})),
		{
			c() {
				W(e.$$.fragment),
					...
					(f = S()),
					(i = _('p')),
					(k = z('Everyone is invited to add CULT events via ')),
					(g = _('a')),
					(d = z('pull request')),
					(p = z('.')),
					(y = S()),
	...
	`)),
				...
				(c1 = S()), W(Q.$$.fragment), this.h();
			},
			l(v) {
				G(e.$$.fragment, v), (r = U(v)), (l = L(v, 'P', {}));
				var A = C(l);
				(t = L(A, 'BR', {})), A.forEach(h), (n = U(v)), (c = L(v, 'DIV', { class: !0 }));
				var b = C(c);
				u = L(b, 'H1', {});
				var l1 = C(u);
				(a = M(l1, 'CULT Events')), l1.forEach(h), (f = U(b)), (i = L(b, 'P', {}));
				var a1 = C(i);
	...
	`
				...
				(e1 = M(v1, 'here')),
					...
					b.forEach(h),
					(K = U(v)),
					(x = L(v, 'ARTICLE', { class: !0 }));
				var n1 = C(x);
				F = L(n1, 'SECTION', { class: !0 });
				var d1 = C(F);
				for (let u1 = 0; u1 < $.length; u1 += 1) $[u1].l(d1);
				d1.forEach(h), (c1 = U(n1)), G(Q.$$.fragment, n1), n1.forEach(h), this.h();
			},
			h() {
				m(g, 'href', 'https://www.youtube.com/watch?v=8lGpZkjnkt4'),
					m(g, 'target', '_blank'),
					m(
						T,
						'href',
						'https://github.com/michael-spengler/cultmagazine/tree/staging/src/routes/events'
					),
					m(T, 'target', '_blank'),
					m(c, 'class', 'text-center'),
					m(F, 'class', 'event-wrapper svelte-1g1aqj2'),
					m(x, 'class', 'wrapper svelte-1g1aqj2');
			},
			m(v, A) {
				Y(e, v, A),
					V(v, r, A),
					...
					V(v, x, A),
					o(x, F);
				for (let b = 0; b < $.length; b += 1) $[b].m(F, null);
			...
			p(v, [A]) {
				if (A & 1) {
					...
					for (b = 0; b < X.length; b += 1) {
						...
						$[b]
							? ($[b].p(l1, A), H($[b], 1))
							: (($[b] = M1(l1)), $[b].c(), H($[b], 1), $[b].m(F, null));
					}
					for ($1(), b = X.length; b < $.length; b += 1) k1(b);
					E1();
				}
			},
			i(v) {
				if (!r1) {
					H(e.$$.fragment, v);
					for (let A = 0; A < X.length; A += 1) H($[A]);
					H(Q.$$.fragment, v), (r1 = !0);
				}
			},
			o(v) {
				P(e.$$.fragment, v), ($ = $.filter(Boolean));
				for (let A = 0; A < $.length; A += 1) P($[A]);
				P(Q.$$.fragment, v), (r1 = !1);
			},
			d(v) {
				j(e, v), v && h(r), v && h(l), v && h(n), v && h(c), v && h(K), v && h(x), A1($, v), j(Q);
			}
		}
	);
}
