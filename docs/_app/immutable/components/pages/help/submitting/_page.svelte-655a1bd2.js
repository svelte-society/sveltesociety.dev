...
import { S as ms } from '../../../../chunks/Select-706a74b6.js';
import { c as Ms } from '../../../../chunks/components-9abf80d5.js';
import { c as Et } from '../../../../chunks/cultproposals-ee6a2386.js';
import { e as Ce } from '../../../../chunks/Select.svelte_svelte_type_style_lang-bb1ab90c.js';
import { S as el } from '../../../../chunks/Seo-a685eb94.js';
...
function sl(n) {
	let m,
		...
		vs,
		ys;
	m = new el({ props: { title: 'Submit component' } });
	function Gs(e) {
		n[16](e);
	}
	let Es = { id: 'type', items: n[13], isClearable: !1, showIndicator: !0 };
	n[0] !== void 0 && (Es.value = n[0]),
		(g = new ms({ props: Es })),
...
`
			...
			h() {
				l(R, 'for', 'type'),
					...
					l(Ee, 'class', 'input-helper svelte-b3ver3'),
...
function al(n, m, c) {
	...
	const G = ['Component', 'Template', 'Tool'].map((b) => ({ label: b, value: b.toLowerCase() })),
		ue = {
			...
			template: { tags: Ce(Et, 'tags'), categories: Ce(Et, 'category') },
			tool: { tags: Ce(Et, 'tags'), categories: Ce(Et, 'category') }
		};
	let I = !1;
	const Ve = () => {
		tl(JSON.stringify(q, null, '	')).then(() => c(8, (I = !1))), c(8, (I = !0));
	};
	let y = G[0],
		T = 'svelte-lorem-ipsum',
		W = 'https://github.com/sveltejs/svelte-lorem-ipsum',
		$ = 'A dummy text generator that does not exist',
		E = 'svelte-lorem-ipsum',
		D = ll(),
		S,
		A;
	Ks(() => {
		const b = new URLSearchParams(location.search).get('type');
		c(0, (y = G.find((z) => z.value == b) || G[0]));
	});
	async function ye() {
	...
	return (
		(n.$$.update = () => {
			n.$$.dirty & 1 && c(12, (w = `${y.value}s`)),
				...
				n.$$.dirty & 1 && c(10, (pe = ue[y.value].tags)),
				n.$$.dirty & 1 && c(9, (B = ue[y.value].categories));
		}),
		[y, T, W, $, E, D, S, A, I, B, pe, q, w, G, Ve, ye, d, L, R, Oe, Ue, P, g, je]
	);
}
class cl extends Fs {
	constructor(m) {
