...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-3b9acdcc.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-75e18c36.js'),
				[
					'chunks/0-75e18c36.js',
					'components/pages/_layout.svelte-ee6217ce.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-bbe4a303.js',
					'chunks/Link-c4428235.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-f3696736.js',
					'chunks/singletons-3b9acdcc.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-38aa2ac9.js'),
				[
					'chunks/1-38aa2ac9.js',
					'components/error.svelte-07985957.js',
					'chunks/index-bbe4a303.js',
					'chunks/stores-f3696736.js',
					'chunks/singletons-3b9acdcc.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-04d4c298.js'),
				[
					'chunks/2-04d4c298.js',
					'components/pages/about/_layout.svelte-a3c7bf7a.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-bbe4a303.js',
					'chunks/Seo-1c5264ae.js',
					'chunks/stores-f3696736.js',
					'chunks/singletons-3b9acdcc.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-950fdf20.js'),
				[
					'chunks/4-950fdf20.js',
					'components/pages/_page.svelte-21662cde.js',
		...
		() =>
			D(
				() => import('./chunks/6-35ad2029.js'),
				[
					'chunks/6-35ad2029.js',
					'components/pages/cultproposals/_page.svelte-cf3df3d9.js',
					'chunks/index-bbe4a303.js',
		...
		() =>
			D(
				() => import('./chunks/7-d6cfdff7.js'),
				[
					'chunks/7-d6cfdff7.js',
					'chunks/_page-e26399b5.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-f32cb524.js',
		...
		() =>
			D(
				() => import('./chunks/8-7e1886ee.js'),
				[
					'chunks/8-7e1886ee.js',
					'components/pages/events/2021-summit-fall/_page.svx-a4e329f5.js',
					'chunks/index-bbe4a303.js',
					'chunks/EventPage-8c8ba51d.js',
		...
		() =>
			D(
				() => import('./chunks/9-7f55da8d.js'),
				[
					'chunks/9-7f55da8d.js',
		...
		() =>
			D(
				() => import('./chunks/10-c1534468.js'),
				[
					'chunks/10-c1534468.js',
		...
		() =>
			D(
				() => import('./chunks/11-bc6c9ed7.js'),
				[
					'chunks/11-bc6c9ed7.js',
		...
		() =>
			D(
				() => import('./chunks/12-88454b8a.js'),
				[
					'chunks/12-88454b8a.js',
		...
		() =>
			D(
				() => import('./chunks/13-fa443d32.js'),
				[
					'chunks/13-fa443d32.js',
					'components/pages/help/submitting/_page.svelte-b0a08cf6.js',
		...
		() =>
			D(
				() => import('./chunks/14-a753898c.js'),
				[
					'chunks/14-a753898c.js',
					'components/pages/markets/_page.svelte-01e18a5a.js',
		...
		() =>
			D(
				() => import('./chunks/15-09c4ac08.js'),
				[
					'chunks/15-09c4ac08.js',
					'components/pages/news/_page.svelte-03f68a49.js',
					'chunks/index-bbe4a303.js',
					'chunks/Select.svelte_svelte_type_style_lang-e1f3ca44.js',
					'assets/Select-6318a4e1.css',
					'chunks/Select.svelte_svelte_type_style_lang-bb1ab90c.js',
		...
		() =>
			D(
				() => import('./chunks/16-4f8b0f19.js'),
				[
					'chunks/16-4f8b0f19.js',
					'components/pages/resources/_page.svelte-ed325f28.js',
					'chunks/index-bbe4a303.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/17-8cfa5886.js'),
				[
					'chunks/17-8cfa5886.js',
					'components/pages/rvltproposals/_page.svelte-db7bf831.js',
