...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-33397e7e.js';
...
const mt = {},
	re = [
		() =>
			V(
				() => import('./chunks/0-72d4d0b1.js'),
				[
					'chunks/0-72d4d0b1.js',
					'components/pages/_layout.svelte-8ad75d08.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-2fad9c0c.js',
					'chunks/Link-2f41dbb7.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-5c626af5.js',
					'chunks/singletons-33397e7e.js'
				],
				import.meta.url
			),
		() =>
			V(
				() => import('./chunks/1-919059ce.js'),
				[
					'chunks/1-919059ce.js',
					'components/error.svelte-098f4f95.js',
					'chunks/index-2fad9c0c.js',
					'chunks/stores-5c626af5.js',
					'chunks/singletons-33397e7e.js'
				],
		...
		() =>
			V(
				() => import('./chunks/2-b73362f5.js'),
				[
					'chunks/2-b73362f5.js',
					'components/pages/about/_layout.svelte-9133c360.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-2fad9c0c.js',
					'chunks/Seo-30c25c5e.js',
					'chunks/stores-5c626af5.js',
					'chunks/singletons-33397e7e.js'
				],
				import.meta.url
		...
		() =>
			V(
				() => import('./chunks/4-2fd8f79b.js'),
				[
					'chunks/4-2fd8f79b.js',
					'components/pages/_page.svelte-903b1efb.js',
		...
		() =>
			V(
				() => import('./chunks/6-3a0e0ccc.js'),
				[
					'chunks/6-3a0e0ccc.js',
					'components/pages/cultproposals/_page.svelte-87a7c9d8.js',
					'chunks/index-2fad9c0c.js',
		...
		() =>
			V(
				() => import('./chunks/7-53825eb1.js'),
				[
					'chunks/7-53825eb1.js',
					'chunks/_page-7d7e404b.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-4896ba9e.js',
		...
		() =>
			V(
				() => import('./chunks/8-06423a79.js'),
				[
					'chunks/8-06423a79.js',
		...
		() =>
			V(
				() => import('./chunks/9-a60d1c6f.js'),
				[
					'chunks/9-a60d1c6f.js',
					'components/pages/help/submitting/_page.svelte-4afa8f85.js',
		...
		() =>
			V(
				() => import('./chunks/10-1cc9a483.js'),
				[
					'chunks/10-1cc9a483.js',
					'components/pages/markets/_page.svelte-681fc5e9.js',
		...
		() =>
			V(
				() => import('./chunks/11-3d9aad21.js'),
				[
					'chunks/11-3d9aad21.js',
					'components/pages/news/_page.svelte-d5874694.js',
					'chunks/index-2fad9c0c.js',
					'chunks/Select.svelte_svelte_type_style_lang-949aa272.js',
					'assets/Select-6318a4e1.css',
					'chunks/Select-8360dfd8.js',
		...
		() =>
			V(
				() => import('./chunks/13-fd6dd485.js'),
				[
					'chunks/13-fd6dd485.js',
					'components/pages/rvltproposals/_page.svelte-fed70f3c.js',
