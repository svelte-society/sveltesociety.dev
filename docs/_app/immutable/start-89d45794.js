...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-a864bddf.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-f471cbbb.js'),
				[
					'chunks/0-f471cbbb.js',
					'components/pages/_layout.svelte-0fd7bbdf.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-2fe5515f.js',
					'chunks/Link-9339c978.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-75bb5758.js',
					'chunks/singletons-a864bddf.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-80b9e9e4.js'),
				[
					'chunks/1-80b9e9e4.js',
					'components/error.svelte-8f1f6366.js',
					'chunks/index-2fe5515f.js',
					'chunks/stores-75bb5758.js',
					'chunks/singletons-a864bddf.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-d95c6628.js'),
				[
					'chunks/2-d95c6628.js',
					'components/pages/about/_layout.svelte-946597c0.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-2fe5515f.js',
					'chunks/Seo-55fc93c2.js',
					'chunks/stores-75bb5758.js',
					'chunks/singletons-a864bddf.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-5153a261.js'),
				[
					'chunks/4-5153a261.js',
					'components/pages/_page.svelte-7e7d73e7.js',
		...
		() =>
			D(
				() => import('./chunks/6-fcfbb3cf.js'),
				[
					'chunks/6-fcfbb3cf.js',
					'components/pages/cultproposals/_page.svelte-94f11af6.js',
					'chunks/index-2fe5515f.js',
		...
		() =>
			D(
				() => import('./chunks/7-6e4112ce.js'),
				[
					'chunks/7-6e4112ce.js',
					'chunks/_page-0dd22037.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-05a247eb.js',
		...
		() =>
			D(
				() => import('./chunks/8-21e8c4c3.js'),
				[
					'chunks/8-21e8c4c3.js',
					'components/pages/events/2021-summit-fall/_page.svx-b614a996.js',
					'chunks/index-2fe5515f.js',
					'chunks/EventPage-75fd35c5.js',
		...
		() =>
			D(
				() => import('./chunks/9-86677a29.js'),
				[
					'chunks/9-86677a29.js',
		...
		() =>
			D(
				() => import('./chunks/10-5b2bf627.js'),
				[
					'chunks/10-5b2bf627.js',
		...
		() =>
			D(
				() => import('./chunks/11-80015325.js'),
				[
					'chunks/11-80015325.js',
		...
		() =>
			D(
				() => import('./chunks/12-94bca0f5.js'),
				[
					'chunks/12-94bca0f5.js',
		...
		() =>
			D(
				() => import('./chunks/13-8be5313e.js'),
				[
					'chunks/13-8be5313e.js',
					'components/pages/help/submitting/_page.svelte-2935b1d0.js',
		...
		() =>
			D(
				() => import('./chunks/14-ca2fbfec.js'),
				[
					'chunks/14-ca2fbfec.js',
					'components/pages/markets/_page.svelte-13229711.js',
		...
		() =>
			D(
				() => import('./chunks/15-1888ecb3.js'),
				[
					'chunks/15-1888ecb3.js',
					'components/pages/news/_page.svelte-1de0f76d.js',
					'chunks/index-2fe5515f.js',
					'chunks/SearchLayout-13a80f1b.js',
					'assets/SearchLayout-6318a4e1.css',
					'chunks/Select-0fad25ba.js',
		...
		() =>
			D(
				() => import('./chunks/17-4f4003ac.js'),
				[
					'chunks/17-4f4003ac.js',
					'components/pages/rvltproposals/_page.svelte-de2532a5.js',
