...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-80f6d197.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-bbe33a08.js'),
				[
					'chunks/0-bbe33a08.js',
					'components/pages/_layout.svelte-777728ef.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-2fe5515f.js',
					'chunks/Link-9339c978.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-c5b4a5e1.js',
					'chunks/singletons-80f6d197.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-261ea9cf.js'),
				[
					'chunks/1-261ea9cf.js',
					'components/error.svelte-8620c20c.js',
					'chunks/index-2fe5515f.js',
					'chunks/stores-c5b4a5e1.js',
					'chunks/singletons-80f6d197.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-ca8ff30e.js'),
				[
					'chunks/2-ca8ff30e.js',
					'components/pages/about/_layout.svelte-e6a341ae.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-2fe5515f.js',
					'chunks/Seo-3932256e.js',
					'chunks/stores-c5b4a5e1.js',
					'chunks/singletons-80f6d197.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-da3704db.js'),
				[
					'chunks/4-da3704db.js',
					'components/pages/_page.svelte-84cb8f82.js',
		...
		() =>
			D(
				() => import('./chunks/6-a2e2b31d.js'),
				[
					'chunks/6-a2e2b31d.js',
					'components/pages/cultproposals/_page.svelte-2ae68900.js',
					'chunks/index-2fe5515f.js',
		...
		() =>
			D(
				() => import('./chunks/7-f083cf89.js'),
				[
					'chunks/7-f083cf89.js',
					'chunks/_page-d1017174.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-40abfe28.js',
		...
		() =>
			D(
				() => import('./chunks/8-cb55ea9f.js'),
				[
					'chunks/8-cb55ea9f.js',
					'components/pages/events/2021-summit-fall/_page.svx-c7f4068f.js',
					'chunks/index-2fe5515f.js',
					'chunks/EventPage-acf34fa0.js',
		...
		() =>
			D(
				() => import('./chunks/9-e65a341d.js'),
				[
					'chunks/9-e65a341d.js',
		...
		() =>
			D(
				() => import('./chunks/10-9cc94ebc.js'),
				[
					'chunks/10-9cc94ebc.js',
		...
		() =>
			D(
				() => import('./chunks/11-30226978.js'),
				[
					'chunks/11-30226978.js',
		...
		() =>
			D(
				() => import('./chunks/12-3672bb60.js'),
				[
					'chunks/12-3672bb60.js',
		...
		() =>
			D(
				() => import('./chunks/13-b124a18e.js'),
				[
					'chunks/13-b124a18e.js',
					'components/pages/help/submitting/_page.svelte-b6cbc161.js',
		...
		() =>
			D(
				() => import('./chunks/14-e3c6b18d.js'),
				[
					'chunks/14-e3c6b18d.js',
					'components/pages/markets/_page.svelte-63b39460.js',
		...
		() =>
			D(
				() => import('./chunks/15-a7be2353.js'),
				[
					'chunks/15-a7be2353.js',
					'components/pages/news/_page.svelte-4223ec95.js',
					'chunks/index-2fe5515f.js',
					'chunks/SearchLayout-13a80f1b.js',
					'assets/SearchLayout-6318a4e1.css',
					'chunks/Select-0fad25ba.js',
		...
		() =>
			D(
				() => import('./chunks/17-9f2480df.js'),
				[
					'chunks/17-9f2480df.js',
					'components/pages/rvltproposals/_page.svelte-6c4438ec.js',
