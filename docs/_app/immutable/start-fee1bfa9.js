...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-12333840.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-8e5fcc48.js'),
				[
					'chunks/0-8e5fcc48.js',
					'components/pages/_layout.svelte-13e4d6c2.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-bbe4a303.js',
					'chunks/Link-c4428235.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-cf161ab2.js',
					'chunks/singletons-12333840.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-b4ee4240.js'),
				[
					'chunks/1-b4ee4240.js',
					'components/error.svelte-6568839d.js',
					'chunks/index-bbe4a303.js',
					'chunks/stores-cf161ab2.js',
					'chunks/singletons-12333840.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-39ea4524.js'),
				[
					'chunks/2-39ea4524.js',
					'components/pages/about/_layout.svelte-436de487.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-bbe4a303.js',
					'chunks/Seo-77474002.js',
					'chunks/stores-cf161ab2.js',
					'chunks/singletons-12333840.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-6ca03c3d.js'),
				[
					'chunks/4-6ca03c3d.js',
					'components/pages/_page.svelte-deee7657.js',
		...
		() =>
			D(
				() => import('./chunks/6-17b62968.js'),
				[
					'chunks/6-17b62968.js',
					'components/pages/cultproposals/_page.svelte-ee829df5.js',
					'chunks/index-bbe4a303.js',
		...
		() =>
			D(
				() => import('./chunks/7-aaac3356.js'),
				[
					'chunks/7-aaac3356.js',
					'chunks/_page-7cbd38a3.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-4b7ae0a5.js',
		...
		() =>
			D(
				() => import('./chunks/8-d442479b.js'),
				[
					'chunks/8-d442479b.js',
					'components/pages/events/2021-summit-fall/_page.svx-7c954b7c.js',
					'chunks/index-bbe4a303.js',
					'chunks/EventPage-0034f771.js',
		...
		() =>
			D(
				() => import('./chunks/9-9f659bbf.js'),
				[
					'chunks/9-9f659bbf.js',
		...
		() =>
			D(
				() => import('./chunks/10-d9cb1257.js'),
				[
					'chunks/10-d9cb1257.js',
		...
		() =>
			D(
				() => import('./chunks/11-4cd8e375.js'),
				[
					'chunks/11-4cd8e375.js',
		...
		() =>
			D(
				() => import('./chunks/12-c8d33d4e.js'),
				[
					'chunks/12-c8d33d4e.js',
		...
		() =>
			D(
				() => import('./chunks/13-c43cdb35.js'),
				[
					'chunks/13-c43cdb35.js',
					'components/pages/help/submitting/_page.svelte-8f545140.js',
		...
		() =>
			D(
				() => import('./chunks/14-8509e603.js'),
				[
					'chunks/14-8509e603.js',
					'components/pages/markets/_page.svelte-2b2e22f3.js',
		...
		() =>
			D(
				() => import('./chunks/15-261cb668.js'),
				[
					'chunks/15-261cb668.js',
					'components/pages/news/_page.svelte-b23dad25.js',
					'chunks/index-bbe4a303.js',
					'chunks/Select.svelte_svelte_type_style_lang-e1f3ca44.js',
					'assets/Select-6318a4e1.css',
					'chunks/Select.svelte_svelte_type_style_lang-bb1ab90c.js',
		...
		() =>
			D(
				() => import('./chunks/16-35782503.js'),
				[
					'chunks/16-35782503.js',
					'components/pages/resources/_page.svelte-a15280e7.js',
					'chunks/index-bbe4a303.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/17-19207139.js'),
				[
					'chunks/17-19207139.js',
					'components/pages/rvltproposals/_page.svelte-e7cf8003.js',
