...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-07985465.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-8a141225.js'),
				[
					'chunks/0-8a141225.js',
					'components/pages/_layout.svelte-793e73b0.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-2fe5515f.js',
					'chunks/Link-9339c978.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-b3470ee2.js',
					'chunks/singletons-07985465.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-8a6054e6.js'),
				[
					'chunks/1-8a6054e6.js',
					'components/error.svelte-c57b69c4.js',
					'chunks/index-2fe5515f.js',
					'chunks/stores-b3470ee2.js',
					'chunks/singletons-07985465.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-c108ad92.js'),
				[
					'chunks/2-c108ad92.js',
					'components/pages/about/_layout.svelte-b834aec5.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-2fe5515f.js',
					'chunks/Seo-54d47ec7.js',
					'chunks/stores-b3470ee2.js',
					'chunks/singletons-07985465.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-c0ed116a.js'),
				[
					'chunks/4-c0ed116a.js',
					'components/pages/_page.svelte-8aa1772a.js',
		...
		() =>
			D(
				() => import('./chunks/6-a53fccfe.js'),
				[
					'chunks/6-a53fccfe.js',
					'components/pages/cultproposals/_page.svelte-77213dc6.js',
					'chunks/index-2fe5515f.js',
		...
		() =>
			D(
				() => import('./chunks/7-bfdade54.js'),
				[
					'chunks/7-bfdade54.js',
					'chunks/_page-e18a4ecf.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-2c173674.js',
		...
		() =>
			D(
				() => import('./chunks/8-d344e01f.js'),
				[
					'chunks/8-d344e01f.js',
					'components/pages/events/2021-summit-fall/_page.svx-46213b2a.js',
					'chunks/index-2fe5515f.js',
					'chunks/EventPage-13027333.js',
		...
		() =>
			D(
				() => import('./chunks/9-1cab69e3.js'),
				[
					'chunks/9-1cab69e3.js',
		...
		() =>
			D(
				() => import('./chunks/10-38cfbd23.js'),
				[
					'chunks/10-38cfbd23.js',
		...
		() =>
			D(
				() => import('./chunks/11-7506ae27.js'),
				[
					'chunks/11-7506ae27.js',
		...
		() =>
			D(
				() => import('./chunks/12-474334f5.js'),
				[
					'chunks/12-474334f5.js',
		...
		() =>
			D(
				() => import('./chunks/13-22d217da.js'),
				[
					'chunks/13-22d217da.js',
					'components/pages/help/submitting/_page.svelte-aa09caac.js',
		...
		() =>
			D(
				() => import('./chunks/14-9bf01b78.js'),
				[
					'chunks/14-9bf01b78.js',
					'components/pages/markets/_page.svelte-80bcb30c.js',
		...
		() =>
			D(
				() => import('./chunks/15-facb9e18.js'),
				[
					'chunks/15-facb9e18.js',
					'components/pages/news/_page.svelte-70c817e1.js',
					'chunks/index-2fe5515f.js',
					'chunks/SearchLayout-13a80f1b.js',
					'assets/SearchLayout-6318a4e1.css',
					'chunks/Select-0fad25ba.js',
		...
		() =>
			D(
				() => import('./chunks/17-a2eb901d.js'),
				[
					'chunks/17-a2eb901d.js',
					'components/pages/rvltproposals/_page.svelte-b63d3e78.js',
