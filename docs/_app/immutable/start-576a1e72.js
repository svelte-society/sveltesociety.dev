...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-5a9413f5.js';
...
const mt = {},
	re = [
		() =>
			V(
				() => import('./chunks/0-2300814e.js'),
				[
					'chunks/0-2300814e.js',
					'components/pages/_layout.svelte-bdc4344a.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-851d3799.js',
					'chunks/Link-8d0a6cfc.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-9ae61ed6.js',
					'chunks/singletons-5a9413f5.js'
				],
				import.meta.url
			),
		() =>
			V(
				() => import('./chunks/1-3272b59d.js'),
				[
					'chunks/1-3272b59d.js',
					'components/error.svelte-6e3193d9.js',
					'chunks/index-851d3799.js',
					'chunks/stores-9ae61ed6.js',
					'chunks/singletons-5a9413f5.js'
				],
		...
		() =>
			V(
				() => import('./chunks/2-e6f6a3e7.js'),
				[
					'chunks/2-e6f6a3e7.js',
					'components/pages/about/_layout.svelte-96368e01.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-851d3799.js',
					'chunks/Seo-a685eb94.js',
					'chunks/stores-9ae61ed6.js',
					'chunks/singletons-5a9413f5.js'
				],
				import.meta.url
		...
		() =>
			V(
				() => import('./chunks/3-13f9cfa4.js'),
				[
					'chunks/3-13f9cfa4.js',
					'components/pages/help/_layout.svelte-59a0253b.js',
					'chunks/index-851d3799.js'
				],
				import.meta.url
			),
		() =>
			V(
				() => import('./chunks/4-04292d43.js'),
				[
					'chunks/4-04292d43.js',
					'components/pages/_page.svelte-a9e7a3b2.js',
		...
		() =>
			V(
				() => import('./chunks/5-241bc5a5.js'),
				[
					'chunks/5-241bc5a5.js',
					'components/pages/about/_page.svx-a54088fc.js',
					'chunks/index-851d3799.js'
				],
				import.meta.url
			),
		() =>
			V(
				() => import('./chunks/6-565fb221.js'),
				[
					'chunks/6-565fb221.js',
					'components/pages/cultproposals/_page.svelte-e451279f.js',
					'chunks/index-851d3799.js',
					'chunks/Select.svelte_svelte_type_style_lang-949aa272.js',
		...
		() =>
			V(
				() => import('./chunks/7-d9c94657.js'),
				[
					'chunks/7-d9c94657.js',
					'chunks/_page-0c1b75e3.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-6630c711.js',
		...
		() =>
			V(
				() => import('./chunks/8-686cadbf.js'),
				[
					'chunks/8-686cadbf.js',
					'components/pages/events/2022-eth-barcelona/_page.svx-7ef313a7.js',
		...
		() =>
			V(
				() => import('./chunks/9-6692fb40.js'),
				[
					'chunks/9-6692fb40.js',
					'components/pages/help/submitting/_page.svelte-655a1bd2.js',
					'assets/+page-891482f7.css',
					'chunks/index-851d3799.js',
					'chunks/Select-706a74b6.js',
					'chunks/Select.svelte_svelte_type_style_lang-bb1ab90c.js',
					'assets/Select-ddd51714.css',
		...
		() =>
			V(
				() => import('./chunks/10-f1c395d3.js'),
				[
					'chunks/10-f1c395d3.js',
					'components/pages/markets/_page.svelte-58839a2a.js',
		...
		() =>
			V(
				() => import('./chunks/11-cd252274.js'),
				[
					'chunks/11-cd252274.js',
					'components/pages/news/_page.svelte-13931ea8.js',
					'chunks/index-851d3799.js',
					'chunks/Select.svelte_svelte_type_style_lang-949aa272.js',
					'assets/Select-6318a4e1.css',
					'chunks/Select-706a74b6.js',
		...
		() =>
			V(
				() => import('./chunks/12-6ff31336.js'),
				[
					'chunks/12-6ff31336.js',
					'components/pages/resources/_page.svelte-7b02e5b9.js',
					'chunks/index-851d3799.js'
				],
				import.meta.url
			),
		() =>
			V(
				() => import('./chunks/13-857568c4.js'),
				[
					'chunks/13-857568c4.js',
					'components/pages/rvltproposals/_page.svelte-1b4b2d3f.js',
