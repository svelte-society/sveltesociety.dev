...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-0a0fff25.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-e1bf444b.js'),
				[
					'chunks/0-e1bf444b.js',
					'components/pages/_layout.svelte-ea1d6085.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-bbe4a303.js',
					'chunks/Link-c4428235.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-5b1f001a.js',
					'chunks/singletons-0a0fff25.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-73425bca.js'),
				[
					'chunks/1-73425bca.js',
					'components/error.svelte-f0db82e4.js',
					'chunks/index-bbe4a303.js',
					'chunks/stores-5b1f001a.js',
					'chunks/singletons-0a0fff25.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-8d186e34.js'),
				[
					'chunks/2-8d186e34.js',
					'components/pages/about/_layout.svelte-6ad334e5.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-bbe4a303.js',
					'chunks/Seo-a888bbf2.js',
					'chunks/stores-5b1f001a.js',
					'chunks/singletons-0a0fff25.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-5e11d14a.js'),
				[
					'chunks/4-5e11d14a.js',
					'components/pages/_page.svelte-cc180368.js',
		...
		() =>
			D(
				() => import('./chunks/6-89bee0a2.js'),
				[
					'chunks/6-89bee0a2.js',
					'components/pages/cultproposals/_page.svelte-39d042bd.js',
					'chunks/index-bbe4a303.js',
		...
		() =>
			D(
				() => import('./chunks/7-8a24d8bf.js'),
				[
					'chunks/7-8a24d8bf.js',
					'chunks/_page-37c0aefe.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-7726fc33.js',
		...
		() =>
			D(
				() => import('./chunks/8-ef378a76.js'),
				[
					'chunks/8-ef378a76.js',
					'components/pages/events/2021-summit-fall/_page.svx-2f3a3e5b.js',
					'chunks/index-bbe4a303.js',
					'chunks/EventPage-83237122.js',
		...
		() =>
			D(
				() => import('./chunks/9-966b2018.js'),
				[
					'chunks/9-966b2018.js',
		...
		() =>
			D(
				() => import('./chunks/10-20d79473.js'),
				[
					'chunks/10-20d79473.js',
		...
		() =>
			D(
				() => import('./chunks/11-b154a11c.js'),
				[
					'chunks/11-b154a11c.js',
		...
		() =>
			D(
				() => import('./chunks/12-6f45d214.js'),
				[
					'chunks/12-6f45d214.js',
		...
		() =>
			D(
				() => import('./chunks/13-14b03c4f.js'),
				[
					'chunks/13-14b03c4f.js',
					'components/pages/help/submitting/_page.svelte-8c3b3cc5.js',
		...
		() =>
			D(
				() => import('./chunks/14-3b0e1db7.js'),
				[
					'chunks/14-3b0e1db7.js',
					'components/pages/markets/_page.svelte-50a1d107.js',
		...
		() =>
			D(
				() => import('./chunks/15-0512648e.js'),
				[
					'chunks/15-0512648e.js',
					'components/pages/news/_page.svelte-4c9f62a2.js',
					'chunks/index-bbe4a303.js',
					'chunks/Select.svelte_svelte_type_style_lang-e1f3ca44.js',
					'assets/Select-6318a4e1.css',
					'chunks/Select.svelte_svelte_type_style_lang-bb1ab90c.js',
		...
		() =>
			D(
				() => import('./chunks/17-3b5a308c.js'),
				[
					'chunks/17-3b5a308c.js',
					'components/pages/rvltproposals/_page.svelte-0b6c5de7.js',
