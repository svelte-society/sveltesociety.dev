...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-f8203a24.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-ff4d20ca.js'),
				[
					'chunks/0-ff4d20ca.js',
					'components/pages/_layout.svelte-6e5af001.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-bbe4a303.js',
					'chunks/Link-c4428235.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-95c8792b.js',
					'chunks/singletons-f8203a24.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-c78a64bc.js'),
				[
					'chunks/1-c78a64bc.js',
					'components/error.svelte-63148b95.js',
					'chunks/index-bbe4a303.js',
					'chunks/stores-95c8792b.js',
					'chunks/singletons-f8203a24.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-0e5b493f.js'),
				[
					'chunks/2-0e5b493f.js',
					'components/pages/about/_layout.svelte-0e1fd2ec.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-bbe4a303.js',
					'chunks/Seo-3d938e6e.js',
					'chunks/stores-95c8792b.js',
					'chunks/singletons-f8203a24.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-927f649d.js'),
				[
					'chunks/4-927f649d.js',
					'components/pages/_page.svelte-70ec2ffa.js',
		...
		() =>
			D(
				() => import('./chunks/6-b8aba655.js'),
				[
					'chunks/6-b8aba655.js',
					'components/pages/cultproposals/_page.svelte-8051c1fc.js',
					'chunks/index-bbe4a303.js',
		...
		() =>
			D(
				() => import('./chunks/7-65f63b8b.js'),
				[
					'chunks/7-65f63b8b.js',
					'chunks/_page-1bf33cb7.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-b666d588.js',
		...
		() =>
			D(
				() => import('./chunks/8-7c6ba295.js'),
				[
					'chunks/8-7c6ba295.js',
					'components/pages/events/2021-summit-fall/_page.svx-f6d4c523.js',
					'chunks/index-bbe4a303.js',
					'chunks/EventPage-914912dc.js',
		...
		() =>
			D(
				() => import('./chunks/9-b76e1ba1.js'),
				[
					'chunks/9-b76e1ba1.js',
		...
		() =>
			D(
				() => import('./chunks/10-50da71b2.js'),
				[
					'chunks/10-50da71b2.js',
		...
		() =>
			D(
				() => import('./chunks/11-e694d0d1.js'),
				[
					'chunks/11-e694d0d1.js',
		...
		() =>
			D(
				() => import('./chunks/12-fbbf0d23.js'),
				[
					'chunks/12-fbbf0d23.js',
		...
		() =>
			D(
				() => import('./chunks/13-d2d98696.js'),
				[
					'chunks/13-d2d98696.js',
					'components/pages/help/submitting/_page.svelte-33f7dd5f.js',
		...
		() =>
			D(
				() => import('./chunks/14-1a4be53a.js'),
				[
					'chunks/14-1a4be53a.js',
					'components/pages/markets/_page.svelte-29d41f0b.js',
		...
		() =>
			D(
				() => import('./chunks/15-c33414fc.js'),
				[
					'chunks/15-c33414fc.js',
					'components/pages/news/_page.svelte-e033516a.js',
					'chunks/index-bbe4a303.js',
					'chunks/Select.svelte_svelte_type_style_lang-e1f3ca44.js',
					'assets/Select-6318a4e1.css',
					'chunks/Select.svelte_svelte_type_style_lang-bb1ab90c.js',
		...
		() =>
			D(
				() => import('./chunks/16-d9118291.js'),
				[
					'chunks/16-d9118291.js',
					'components/pages/resources/_page.svelte-193842a3.js',
					'chunks/index-bbe4a303.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/17-4820c3a9.js'),
				[
					'chunks/17-4820c3a9.js',
					'components/pages/rvltproposals/_page.svelte-417c2b7a.js',
