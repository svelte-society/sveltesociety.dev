...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-c19c8c00.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-eea3b1c0.js'),
				[
					'chunks/0-eea3b1c0.js',
					'components/pages/_layout.svelte-8dec4c5c.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-2fe5515f.js',
					'chunks/Link-9339c978.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-26df9a41.js',
					'chunks/singletons-c19c8c00.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-cd6bc5e8.js'),
				[
					'chunks/1-cd6bc5e8.js',
					'components/error.svelte-b0f1e10c.js',
					'chunks/index-2fe5515f.js',
					'chunks/stores-26df9a41.js',
					'chunks/singletons-c19c8c00.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-cf824541.js'),
				[
					'chunks/2-cf824541.js',
					'components/pages/about/_layout.svelte-7719feea.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-2fe5515f.js',
					'chunks/Seo-535b3afa.js',
					'chunks/stores-26df9a41.js',
					'chunks/singletons-c19c8c00.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-1da22264.js'),
				[
					'chunks/4-1da22264.js',
					'components/pages/_page.svelte-444f0d84.js',
		...
		() =>
			D(
				() => import('./chunks/6-7d59df7a.js'),
				[
					'chunks/6-7d59df7a.js',
					'components/pages/cultproposals/_page.svelte-39f79978.js',
					'chunks/index-2fe5515f.js',
		...
		() =>
			D(
				() => import('./chunks/7-05bc06f4.js'),
				[
					'chunks/7-05bc06f4.js',
					'chunks/_page-acb2c524.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-ec5a8846.js',
		...
		() =>
			D(
				() => import('./chunks/8-4e556993.js'),
				[
					'chunks/8-4e556993.js',
					'components/pages/events/2021-summit-fall/_page.svx-a463062a.js',
					'chunks/index-2fe5515f.js',
					'chunks/EventPage-fd8f6a04.js',
		...
		() =>
			D(
				() => import('./chunks/9-dd392fef.js'),
				[
					'chunks/9-dd392fef.js',
		...
		() =>
			D(
				() => import('./chunks/10-131a40c6.js'),
				[
					'chunks/10-131a40c6.js',
		...
		() =>
			D(
				() => import('./chunks/11-893b1e5c.js'),
				[
					'chunks/11-893b1e5c.js',
		...
		() =>
			D(
				() => import('./chunks/12-8cd2ddb0.js'),
				[
					'chunks/12-8cd2ddb0.js',
		...
		() =>
			D(
				() => import('./chunks/13-b49bc385.js'),
				[
					'chunks/13-b49bc385.js',
					'components/pages/help/submitting/_page.svelte-d80efdba.js',
		...
		() =>
			D(
				() => import('./chunks/14-af689ff4.js'),
				[
					'chunks/14-af689ff4.js',
					'components/pages/markets/_page.svelte-5e983c90.js',
		...
		() =>
			D(
				() => import('./chunks/15-ffee39ea.js'),
				[
					'chunks/15-ffee39ea.js',
					'components/pages/news/_page.svelte-5ea1ac01.js',
					'chunks/index-2fe5515f.js',
					'chunks/SearchLayout-13a80f1b.js',
					'assets/SearchLayout-6318a4e1.css',
					'chunks/Select-0fad25ba.js',
		...
		() =>
			D(
				() => import('./chunks/17-35167e79.js'),
				[
					'chunks/17-35167e79.js',
					'components/pages/rvltproposals/_page.svelte-1026f54a.js',
