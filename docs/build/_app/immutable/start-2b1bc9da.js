...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-79537efd.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-2ee640a5.js'),
				[
					'chunks/0-2ee640a5.js',
					'components/pages/_layout.svelte-b8e11aa6.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-2fe5515f.js',
					'chunks/Link-9339c978.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-bd836b2e.js',
					'chunks/singletons-79537efd.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-1cfbf558.js'),
				[
					'chunks/1-1cfbf558.js',
					'components/error.svelte-1a26ad80.js',
					'chunks/index-2fe5515f.js',
					'chunks/stores-bd836b2e.js',
					'chunks/singletons-79537efd.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-b734fb75.js'),
				[
					'chunks/2-b734fb75.js',
					'components/pages/about/_layout.svelte-39a09d5f.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-2fe5515f.js',
					'chunks/Seo-c98eb7f1.js',
					'chunks/stores-bd836b2e.js',
					'chunks/singletons-79537efd.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-d23e8cc7.js'),
				[
					'chunks/4-d23e8cc7.js',
					'components/pages/_page.svelte-39baed17.js',
		...
		() =>
			D(
				() => import('./chunks/6-ec263a1a.js'),
				[
					'chunks/6-ec263a1a.js',
					'components/pages/cultproposals/_page.svelte-fe94e26b.js',
					'chunks/index-2fe5515f.js',
		...
		() =>
			D(
				() => import('./chunks/7-039148be.js'),
				[
					'chunks/7-039148be.js',
					'chunks/_page-148575f5.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-5bd8df6f.js',
		...
		() =>
			D(
				() => import('./chunks/8-4c2c7035.js'),
				[
					'chunks/8-4c2c7035.js',
					'components/pages/events/2021-summit-fall/_page.svx-af68e560.js',
					'chunks/index-2fe5515f.js',
					'chunks/EventPage-69577002.js',
		...
		() =>
			D(
				() => import('./chunks/9-db04dde1.js'),
				[
					'chunks/9-db04dde1.js',
		...
		() =>
			D(
				() => import('./chunks/10-a1dd4d0a.js'),
				[
					'chunks/10-a1dd4d0a.js',
		...
		() =>
			D(
				() => import('./chunks/11-e16024ec.js'),
				[
					'chunks/11-e16024ec.js',
		...
		() =>
			D(
				() => import('./chunks/12-9a493b47.js'),
				[
					'chunks/12-9a493b47.js',
		...
		() =>
			D(
				() => import('./chunks/13-3ee36885.js'),
				[
					'chunks/13-3ee36885.js',
					'components/pages/help/submitting/_page.svelte-bb9dbfd0.js',
		...
		() =>
			D(
				() => import('./chunks/14-35a762ae.js'),
				[
					'chunks/14-35a762ae.js',
					'components/pages/markets/_page.svelte-c67b228a.js',
		...
		() =>
			D(
				() => import('./chunks/15-9e899a10.js'),
				[
					'chunks/15-9e899a10.js',
					'components/pages/news/_page.svelte-6fc94639.js',
					'chunks/index-2fe5515f.js',
					'chunks/SearchLayout-13a80f1b.js',
					'assets/SearchLayout-6318a4e1.css',
					'chunks/Select-0fad25ba.js',
		...
		() =>
			D(
				() => import('./chunks/17-d703aa96.js'),
				[
					'chunks/17-d703aa96.js',
					'components/pages/rvltproposals/_page.svelte-b4e6237f.js',
