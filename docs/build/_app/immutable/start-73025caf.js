...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-7e9a75e8.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-93e0fda8.js'),
				[
					'chunks/0-93e0fda8.js',
					'components/pages/_layout.svelte-5ceb33c5.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-2fad9c0c.js',
					'chunks/Link-2f41dbb7.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-80acc175.js',
					'chunks/singletons-7e9a75e8.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-f4834b8f.js'),
				[
					'chunks/1-f4834b8f.js',
					'components/error.svelte-2c81408e.js',
					'chunks/index-2fad9c0c.js',
					'chunks/stores-80acc175.js',
					'chunks/singletons-7e9a75e8.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-71f6d119.js'),
				[
					'chunks/2-71f6d119.js',
					'components/pages/about/_layout.svelte-8864f077.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-2fad9c0c.js',
					'chunks/Seo-c7090712.js',
					'chunks/stores-80acc175.js',
					'chunks/singletons-7e9a75e8.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-7c59257b.js'),
				[
					'chunks/4-7c59257b.js',
					'components/pages/_page.svelte-85d48180.js',
		...
		() =>
			D(
				() => import('./chunks/6-b19c660c.js'),
				[
					'chunks/6-b19c660c.js',
					'components/pages/cultproposals/_page.svelte-ca4521ac.js',
					'chunks/index-2fad9c0c.js',
		...
		() =>
			D(
				() => import('./chunks/7-fb2d6b97.js'),
				[
					'chunks/7-fb2d6b97.js',
					'chunks/_page-36be9e9a.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-adbab8d0.js',
		...
		() =>
			D(
				() => import('./chunks/8-483e2927.js'),
				[
					'chunks/8-483e2927.js',
					'components/pages/events/2021-summit-fall/_page.svx-08dad30c.js',
					'chunks/index-2fad9c0c.js',
					'chunks/EventPage-91b1e80f.js',
		...
		() =>
			D(
				() => import('./chunks/9-4e001804.js'),
				[
					'chunks/9-4e001804.js',
		...
		() =>
			D(
				() => import('./chunks/10-47e1ad6f.js'),
				[
					'chunks/10-47e1ad6f.js',
		...
		() =>
			D(
				() => import('./chunks/11-895eb79e.js'),
				[
					'chunks/11-895eb79e.js',
		...
		() =>
			D(
				() => import('./chunks/12-6efbd95b.js'),
				[
					'chunks/12-6efbd95b.js',
		...
		() =>
			D(
				() => import('./chunks/13-05d1fc0c.js'),
				[
					'chunks/13-05d1fc0c.js',
					'components/pages/help/submitting/_page.svelte-5ceb69b1.js',
		...
		() =>
			D(
				() => import('./chunks/14-6e123781.js'),
				[
					'chunks/14-6e123781.js',
					'components/pages/markets/_page.svelte-9c89bdbe.js',
		...
		() =>
			D(
				() => import('./chunks/15-129ffedf.js'),
				[
					'chunks/15-129ffedf.js',
					'components/pages/news/_page.svelte-b53b1005.js',
					'chunks/index-2fad9c0c.js',
					'chunks/Select.svelte_svelte_type_style_lang-949aa272.js',
					'assets/Select-6318a4e1.css',
					'chunks/Select-8360dfd8.js',
		...
		() =>
			D(
				() => import('./chunks/16-778afb00.js'),
				[
					'chunks/16-778afb00.js',
					'components/pages/resources/_page.svelte-89780f47.js',
		...
		() =>
			D(
				() => import('./chunks/17-59eb53e7.js'),
				[
					'chunks/17-59eb53e7.js',
					'components/pages/rvltproposals/_page.svelte-0278e4da.js',
