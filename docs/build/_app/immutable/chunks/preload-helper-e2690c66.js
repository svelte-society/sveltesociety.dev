...
var i = (e, t, r) => (f(e, typeof t != 'symbol' ? t + '' : t, r), r);
class m {
	constructor(t, r) {
		i(this, 'name', 'HttpError');
		i(this, 'stack');
		(this.status = t), (this.message = r != null ? r : `Error: ${t}`);
	}
	toString() {
		return this.message;
	}
						...
						if (
							...
							return new Promise((a, d) => {
								s.addEventListener('load', a),
									s.addEventListener('error', () => d(new Error(`Unable to preload CSS for ${n}`)));
							});
					})
			  ).then(() => t());
	};
export { m as H, R, k as _, S as e };
