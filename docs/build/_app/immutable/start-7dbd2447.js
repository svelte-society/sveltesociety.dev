...
import {
	...
	i as We,
	c as Fe
} from './chunks/singletons-916cc6bb.js';
...
const mt = {},
	re = [
		() =>
			D(
				() => import('./chunks/0-a5a68577.js'),
				[
					'chunks/0-a5a68577.js',
					'components/pages/_layout.svelte-db97bbc1.js',
					'assets/+layout-1798ff3d.css',
					'chunks/index-bbe4a303.js',
					'chunks/Link-c4428235.js',
					'assets/Link-5c73b3cb.css',
					'chunks/stores-02de2e3c.js',
					'chunks/singletons-916cc6bb.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/1-755793b6.js'),
				[
					'chunks/1-755793b6.js',
					'components/error.svelte-1f3e7f27.js',
					'chunks/index-bbe4a303.js',
					'chunks/stores-02de2e3c.js',
					'chunks/singletons-916cc6bb.js'
				],
		...
		() =>
			D(
				() => import('./chunks/2-daec21e0.js'),
				[
					'chunks/2-daec21e0.js',
					'components/pages/about/_layout.svelte-96eda2d6.js',
					'assets/+layout-a7dc71bf.css',
					'chunks/index-bbe4a303.js',
					'chunks/Seo-b6a31980.js',
					'chunks/stores-02de2e3c.js',
					'chunks/singletons-916cc6bb.js'
				],
				import.meta.url
		...
		() =>
			D(
				() => import('./chunks/4-921421aa.js'),
				[
					'chunks/4-921421aa.js',
					'components/pages/_page.svelte-b5e348ab.js',
		...
		() =>
			D(
				() => import('./chunks/6-0542efab.js'),
				[
					'chunks/6-0542efab.js',
					'components/pages/cultproposals/_page.svelte-550a3e43.js',
					'chunks/index-bbe4a303.js',
		...
		() =>
			D(
				() => import('./chunks/7-9813d62c.js'),
				[
					'chunks/7-9813d62c.js',
					'chunks/_page-f8cd296c.js',
					'chunks/preload-helper-e2690c66.js',
					'components/pages/events/_page.svelte-77e44d76.js',
		...
		() =>
			D(
				() => import('./chunks/8-9a2e0516.js'),
				[
					'chunks/8-9a2e0516.js',
					'components/pages/events/2021-summit-fall/_page.svx-4610b358.js',
					'chunks/index-bbe4a303.js',
					'chunks/EventPage-f001fc8e.js',
		...
		() =>
			D(
				() => import('./chunks/9-2c67746b.js'),
				[
					'chunks/9-2c67746b.js',
		...
		() =>
			D(
				() => import('./chunks/10-3821eb90.js'),
				[
					'chunks/10-3821eb90.js',
		...
		() =>
			D(
				() => import('./chunks/11-f08b60fa.js'),
				[
					'chunks/11-f08b60fa.js',
		...
		() =>
			D(
				() => import('./chunks/12-cdd098bc.js'),
				[
					'chunks/12-cdd098bc.js',
		...
		() =>
			D(
				() => import('./chunks/13-df586e54.js'),
				[
					'chunks/13-df586e54.js',
					'components/pages/help/submitting/_page.svelte-c1b050a9.js',
		...
		() =>
			D(
				() => import('./chunks/14-600d298c.js'),
				[
					'chunks/14-600d298c.js',
					'components/pages/markets/_page.svelte-83c24fab.js',
		...
		() =>
			D(
				() => import('./chunks/15-96c3db15.js'),
				[
					'chunks/15-96c3db15.js',
					'components/pages/news/_page.svelte-012110bc.js',
					'chunks/index-bbe4a303.js',
					'chunks/Select.svelte_svelte_type_style_lang-e1f3ca44.js',
					'assets/Select-6318a4e1.css',
					'chunks/Select.svelte_svelte_type_style_lang-bb1ab90c.js',
		...
		() =>
			D(
				() => import('./chunks/16-1d770c21.js'),
				[
					'chunks/16-1d770c21.js',
					'components/pages/resources/_page.svelte-7c493e90.js',
					'chunks/index-bbe4a303.js'
				],
				import.meta.url
			),
		() =>
			D(
				() => import('./chunks/17-b46693fd.js'),
				[
					'chunks/17-b46693fd.js',
					'components/pages/rvltproposals/_page.svelte-42ca6d10.js',
